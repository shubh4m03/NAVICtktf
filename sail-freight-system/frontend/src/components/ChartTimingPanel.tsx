  ...
  return (
    <div className="card panel-enter flex flex-col" role="region" aria-label="Charter Timing Recommendation">
      <div className="card-header">
        ...
        <span className="card-title">Charter Timing</span>
      </div>

      <div className="p-3 flex flex-col gap-2 flex-1">
        {/* Suggested window — hero */}
        <div className="rounded bg-primary-muted border border-primary-border px-3 py-2">
          <p className="text-2xs text-primary font-semibold uppercase tracking-wide mb-0.5">
            Suggested Window
          </p>
        ...
        {/* Market condition */}
        <div>
          <p className="text-2xs text-ink-tertiary uppercase tracking-wide mb-0.5">Market Condition</p>
          <div className="flex items-start gap-1.5">
            <span className="mt-0.5 flex-shrink-0 text-status-green">
        ...
        <div className="flex-1">
          <p className="text-2xs text-ink-tertiary uppercase tracking-wide mb-1">Rationale</p>
