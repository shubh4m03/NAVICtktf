...
const BREAKDOWN_ITEMS: BreakdownItem[] = [
  { key: 'freight', label: 'Freight',    colorClass: 'text-primary',           barClass: 'bg-primary' },
  { key: 'fuel',    label: 'Fuel',       colorClass: 'text-status-amber',       barClass: 'bg-status-amber' },
  { key: 'port',    label: 'Port',       colorClass: 'text-ink-secondary',      barClass: 'bg-ink-tertiary' },
  { key: 'waiting', label: 'Waiting',    colorClass: 'text-status-red',         barClass: 'bg-status-red' },
]
  ...
  return (
    <div className="card panel-enter flex flex-col" role="region" aria-label="Voyage Cost">
      ...
      <div className="p-3 flex flex-col gap-2 flex-1">
        {/* Hero total */}
        <div>
          <p className="text-2xs text-ink-tertiary uppercase tracking-wide mb-0.5">Total Cost</p>
        ...
        {/* Stacked bar */}
        <div>
          <p className="text-2xs text-ink-tertiary uppercase tracking-wide mb-1">Cost Breakdown</p>
            ...
            return (
              <div key={key} className="hover-row flex items-center justify-between">
                ...
                <div className="flex items-center gap-2">
                  <span className="text-2xs text-ink-tertiary">{pct}%</span>
