  ...
  return (
    <div className="hover-row flex items-center justify-between">
      ...
      <span className="num text-sm text-ink">
        {value.toFixed(1)}
        <span className="text-xs text-ink-tertiary ml-1">{unit}</span>
      </span>
    </div>
  )
}
    ...
    <div className="card panel-enter flex flex-col" role="region" aria-label="Freight Rate Forecast">
      ...
      <div className="p-3 flex flex-col gap-2 flex-1">
        ...
        <div className="flex items-end justify-between">
          <div>
            <p className="text-2xs text-ink-tertiary uppercase tracking-wide mb-0.5">Current Rate</p>
        ...
        {/* Horizon table */}
        <p className="text-2xs text-ink-tertiary uppercase tracking-wide">Rate Horizon ($/t)</p>
        ...
        <div className="mt-auto pt-2 border-t border-border">
          <p className="text-xs text-ink-secondary">
            <span className="font-medium text-status-green">↑</span>{' '}
